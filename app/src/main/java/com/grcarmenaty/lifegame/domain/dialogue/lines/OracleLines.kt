...
internal object OracleLines {
    ...
    val all: List<DialogueLine> = listOf(
        ...
        DialogueLine("or_la_merce", A, "La Mercè wakes. Fires, processions, the city singing itself. The weave thickens.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
        ...
        DialogueLine("or_reis", A, "Gift day. Old omens travel disguised as packages.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnReis),
            cooldownGroup = "or_holiday", cooldownPicks = 1),
        DialogueLine("or_carnaval", A, "Carnaval. The mask reveals what the face conceals.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnCarnaval),
            cooldownGroup = "or_holiday", cooldownPicks = 1),
        DialogueLine("or_divendres_sant", A, "The pause day. The weave is held; nothing tightens, nothing slips.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnDivendresSant),
            cooldownGroup = "or_holiday", cooldownPicks = 1),
        DialogueLine("or_pasqua", A, "The first day after the pause. The thread begins again.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnPasqua),
            cooldownGroup = "or_holiday", cooldownPicks = 1),
        DialogueLine("or_festa_del_treball", A, "The workers' day. Tools are set down. The hands remember the shape.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnFestaDelTreball),
            cooldownGroup = "or_holiday", cooldownPicks = 1),
        DialogueLine("or_festa_major_gracia", A, "Gràcia weaves itself in paper and light. Walk in it; you will be inside the cloth.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnFestaMajorGracia),
            cooldownGroup = "or_holiday", cooldownPicks = 1),
        DialogueLine("or_assumpcio", A, "High summer pause. The wheel slows.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnAssumpcio),
            cooldownGroup = "or_holiday", cooldownPicks = 1),
        DialogueLine("or_hispanitat", A, "A loaded date. The thread frays here for many. Tend yours carefully.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnHispanitat),
            cooldownGroup = "or_holiday", cooldownPicks = 1),
        DialogueLine("or_castanyada", A, "Castanyada. The turning toward dark. The remembered are remembered without speech.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnCastanyada),
            cooldownGroup = "or_holiday", cooldownPicks = 1),
        DialogueLine("or_constitucio", A, "Civic day. The weave of many threads holds.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnConstitucio),
            cooldownGroup = "or_holiday", cooldownPicks = 1),
        DialogueLine("or_immaculada", A, "Pont. The bridge between work and rest crosses itself.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnImmaculada),
            cooldownGroup = "or_holiday", cooldownPicks = 1),
        DialogueLine("or_sant_esteve", A, "Day after. The fires settle. The room remains.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnSantEsteve),
            cooldownGroup = "or_holiday", cooldownPicks = 1),
        DialogueLine("or_cap_d_any_eve", A, "The last hours of the wheel. Twelve grapes, twelve wishes. Pick them carefully.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,

...
internal object DrillSergeantLines {
    ...
    val all: List<DialogueLine> = listOf(
        ...
        DialogueLine(
            id = "ds_nadal",
            archetype = A,
            text = "Nadal. Family duty is duty too. One light rep, then go. Skip and tell me — I'll respect it. Vanish without telling me, I won't.",
            tier = LineTier.ESSENTIAL, category = LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
        ...
        DialogueLine("ds_reis", A, "Gift day. Hand them out, then back to the list. Kids get a pass; you don't.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnReis),
            cooldownGroup = "ds_holiday", cooldownPicks = 1),
        DialogueLine("ds_carnaval", A, "Masks. Theatre. Fine. Do one rep before you put yours on.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnCarnaval),
            cooldownGroup = "ds_holiday", cooldownPicks = 1),
        DialogueLine("ds_divendres_sant", A, "Quiet day. The city pauses. Don't mistake quiet for inactivity.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnDivendresSant),
            cooldownGroup = "ds_holiday", cooldownPicks = 1),
        DialogueLine("ds_pasqua", A, "Long-weekend Monday. Soft session. Real week starts tomorrow.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnPasqua),
            cooldownGroup = "ds_holiday", cooldownPicks = 1),
        DialogueLine("ds_festa_del_treball", A, "Workers' day. Acknowledge it. Then work — your way.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnFestaDelTreball),
            cooldownGroup = "ds_holiday", cooldownPicks = 1),
        DialogueLine("ds_festa_major_gracia", A, "Gràcia's decorated streets are out there. Go look. Then come back to the list.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnFestaMajorGracia),
            cooldownGroup = "ds_holiday", cooldownPicks = 1),
        DialogueLine("ds_assumpcio", A, "Mid-August holiday. Heat. Move early, then rest. Soft program.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnAssumpcio),
            cooldownGroup = "ds_holiday", cooldownPicks = 1),
        DialogueLine("ds_hispanitat", A, "Loaded holiday. Whichever side of it you sit, don't waste the day.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnHispanitat),
            cooldownGroup = "ds_holiday", cooldownPicks = 1),
        DialogueLine("ds_castanyada", A, "Chestnut night. Eat the panellets. Tomorrow we're back at full pace.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnCastanyada),
            cooldownGroup = "ds_holiday", cooldownPicks = 1),
        DialogueLine("ds_constitucio", A, "Civic day. Long weekend incoming. Don't drift through it.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnConstitucio),
            cooldownGroup = "ds_holiday", cooldownPicks = 1),
        DialogueLine("ds_immaculada", A, "Pont kicks off. Plan the load now or it disappears into a five-day fog.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnImmaculada),
            cooldownGroup = "ds_holiday", cooldownPicks = 1),
        DialogueLine("ds_sant_esteve", A, "Day after. Slow morning, soft load. Don't fall fully out of rhythm.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnSantEsteve),
            cooldownGroup = "ds_holiday", cooldownPicks = 1),
        DialogueLine("ds_cap_d_any_eve", A, "Last day. Close what you opened. Don't enter the new year carrying debt.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,

...
internal object GentleMentorLines {
    ...
    val all: List<DialogueLine> = listOf(
        ...
        DialogueLine("gm_reis", A, "Gift day. Whatever you give or receive, do it slowly. It's kinder that way.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnReis),
            cooldownGroup = "gm_holiday", cooldownPicks = 1),
        DialogueLine("gm_carnaval", A, "Carnaval. You're allowed to be someone different for a day.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnCarnaval),
            cooldownGroup = "gm_holiday", cooldownPicks = 1),
        DialogueLine("gm_divendres_sant", A, "A quiet day. The city softens. Let yourself match it.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnDivendresSant),
            cooldownGroup = "gm_holiday", cooldownPicks = 1),
        DialogueLine("gm_pasqua", A, "A long weekend. Move kindly. Don't push.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnPasqua),
            cooldownGroup = "gm_holiday", cooldownPicks = 1),
        DialogueLine("gm_festa_del_treball", A, "Workers' day. Rest is part of the work, too.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnFestaDelTreball),
            cooldownGroup = "gm_holiday", cooldownPicks = 1),
        DialogueLine("gm_festa_major_gracia", A, "Festa Major de Gràcia. The streets will be dressed. Wander them gently.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnFestaMajorGracia),
            cooldownGroup = "gm_holiday", cooldownPicks = 1),
        DialogueLine("gm_assumpcio", A, "Mid-August. Even the city slows down. Be slow with it.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnAssumpcio),
            cooldownGroup = "gm_holiday", cooldownPicks = 1),
        DialogueLine("gm_hispanitat", A, "A holiday. Some hold it lightly, some heavily. Whatever you do, do it with care.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnHispanitat),
            cooldownGroup = "gm_holiday", cooldownPicks = 1),
        DialogueLine("gm_castanyada", A, "Castanyada. Chestnuts, panellets, soft light. Take the cosy.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnCastanyada),
            cooldownGroup = "gm_holiday", cooldownPicks = 1),
        DialogueLine("gm_constitucio", A, "Civic day. A long weekend opens. Let it open you a little too.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnConstitucio),
            cooldownGroup = "gm_holiday", cooldownPicks = 1),
        DialogueLine("gm_immaculada", A, "Pont. A long stretch of days. Lay it down on yourself like a blanket.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnImmaculada),
            cooldownGroup = "gm_holiday", cooldownPicks = 1),
        DialogueLine("gm_sant_esteve", A, "The day after. Be tender — yesterday was a lot.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
            stateRequirements = listOf(OnSantEsteve),
            cooldownGroup = "gm_holiday", cooldownPicks = 1),
        DialogueLine("gm_cap_d_any_eve", A, "Last day. Whatever you finish or don't, you've arrived here. That counts.",
            LineTier.ESSENTIAL, LineCategory.OPENER,
            recencyKey = RecencyKey.TODAY, lifeEvent = true,
